...
const cases = [
  ...
  ["status_active", new types.Active(), "shared_types__active"],
  ["status_pending", new types.Pending(), "shared_types__pending"],
  ["item", item, "{shared_types__item,7,<<119,114,101,110,99,104>>,12.5,true}"],
  ["item_whole_float", wholeFloatItem, "{shared_types__item,9,<<102,108,111,97,116,121>>,2.0,true}"],
  ["tree", tree, "{shared_types__node,1,shared_types__leaf,{shared_types__node,2,shared_types__leaf,shared_types__leaf}}"],
  [
    "item_error",
    new types.ValidationFailed("name", "required"),
    "{shared_types__validation_failed,<<110,97,109,101>>,<<114,101,113,117,105,114,101,100>>}",
  ],
  ["item_error_not_found", new types.NotFound(), "shared_types__not_found"],
  [
    "with_floats",
    new types.WithFloats(2.0, 3.0, "whole"),
    "{shared_types__with_floats,2.0,3.0,<<119,104,111,108,101>>}",
  ],
  [
    "list_of_items",
    gleam.toList([item, wholeFloatItem]),
    "[{shared_types__item,7,<<119,114,101,110,99,104>>,12.5,true},{shared_types__item,9,<<102,108,111,97,116,121>>,2.0,true}]",
  ],
  ["option_item", new option.Some(item), "{some,{shared_types__item,7,<<119,114,101,110,99,104>>,12.5,true}}"],
  [
    "dict_string_item",
    itemDict,
    "#{<<111,110,101>> => {shared_types__item,7,<<119,114,101,110,99,104>>,12.5,true},<<116,119,111>> => {shared_types__item,9,<<102,108,111,97,116,121>>,2.0,true}}",
  ],
  [
    "nested_record",
    nested,
    "{shared_types__nested_record,[{shared_types__item,7,<<119,114,101,110,99,104>>,12.5,true},{shared_types__item,9,<<102,108,111,97,116,121>>,2.0,true}],{some,{shared_types__item,8,<<98,111,108,116>>,1.25,false}},[shared_types__pending,shared_types__active,shared_types__cancelled],#{<<111,110,101>> => {shared_types__item,7,<<119,114,101,110,99,104>>,12.5,true},<<116,119,111>> => {shared_types__item,9,<<102,108,111,97,116,121>>,2.0,true}}}",
  ],
];
