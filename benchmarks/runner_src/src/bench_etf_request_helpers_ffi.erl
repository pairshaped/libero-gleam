...
load_admin(Value) ->
    {_, Title, Selected, Filters, Flags} =
        'generated@rpc_wire':encode_shared_bench__admin_summary(Value),
    {server_load_admin, Title, Selected, Filters, Flags}.

load_records(Value) ->
    {_, Items, Total, Page} =
        'generated@rpc_wire':encode_shared_bench__record_page(Value),
    {server_load_records, Items, Total, Page}.

load_game(Value) ->
    {_, GameId, Home, Away, Events, ByCode} =
        'generated@rpc_wire':encode_shared_bench__game_data(Value),
    {server_load_game, GameId, Home, Away, Events, ByCode}.

load_shots(Value) ->
    {_, GameId, Shots, ByPlayer} =
        'generated@rpc_wire':encode_shared_bench__shot_payload(Value),
...
load_matrix(Value) ->
    {_, Blob, Status, Pair, Position, MaybePair, FallibleItem, IntLookup,
     BoolLookup, NestedResult, Unit} =
        'generated@rpc_wire':encode_shared_bench__type_matrix(Value),
