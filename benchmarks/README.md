...
Libero, generates Libero artifacts from explicit Rally-style seeds, then runs
benchmark modules against the generated helpers. Results overwrite the current
report and CSV files in this directory.
